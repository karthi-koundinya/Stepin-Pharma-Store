...
void test_add_medicine(void) {
  number AddMedicine = {"Add_1", "mname", "1234", "1234", "cname", "12-12-1234", "12-12-1234"};
  TEST_ASSERT_EQUAL(0, add_medicine(&new_medicine));
}

void test_delete_medicine(void) {
  m new_medicine = {"Delete_1", "mname", "1234", "1234", "cname", "12-12-1234", "12-12-1234"};
  TEST_ASSERT_EQUAL(0, add_medicine(&new_medicine));
  TEST_ASSERT_EQUAL(0, delete_medicine(new_medicine.name));
}

void test_modify_medicine(void) {
  m new_medicine = {"Modify_1", "mname", "1234", "1234", "cname", "12-12-1234", "12-12-1234"};
  m new_medicine1 = {"Modified_id", "mname1", "123", "123", "cname1", "11-11-1235", "11-10-1235"};
  TEST_ASSERT_EQUAL(0, add_medicine(&new_medicine));
...
void test_search_medicine(void) {
  m new_medicine = {"Search_1", "mname", "1234", "1234", "cname", "12-12-1234", "12-12-1234"};
  TEST_ASSERT_EQUAL(0, add_medicine(&new_medicine));
